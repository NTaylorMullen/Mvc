...
#if NET45
        [Fact]
        public void DisplayHasPrescedence_IfDisplayNameAlsoSet()
        {
            // Arrange
            var display = new DisplayAttribute { Name = "display" };
            var displayName = new DisplayNameAttribute("displayName");
